---
title:  "CNCF 플랫폼 백서(White Paper) (v1)"
...
{{% pageinfo color="info" %}}
Please refer to the [Platform Engineering Maturity Model](/ko/whitepapers/platform-eng-maturity-model/v1/) created after this paper was originally published.
{{% /pageinfo %}}
...
<figure><img src="assets/platforms-def.drawio.png" alt="제품과 플랫폼 그리고 기능 제공업체 간의 관계 그래프"><figcaption><p>제품과 플랫폼 그리고 기능 제공업체 간의 관계 그래프</p></figcaption></figure>
